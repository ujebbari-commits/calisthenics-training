...
(() => {
  ...
  const ui=read(UI_KEY,{tab:'today',openExercise:null,openTodayExercise:null,openProgramDay:null,openProgramExercise:null,trainingMode:1,progressExercise:null,exerciseSearch:'',exercisePart:'all',todayMenuKey:null});
  ...
  function setupSections(){
    ...
    todayInlineCard.innerHTML='<div class="section-head today-workout-head"><div><p class="eyebrow">TODAY\'S WORKOUT</p><h2 id="todayInlineTitle">今日のメニュー</h2><p id="todayInlineDesc" class="muted"></p></div><div class="today-completion-controls"><label><input id="todayCompleteDate" type="date" aria-label="完了日"></label><button type="button" id="todayCompleteBtn" class="primary">完了</button><small id="todayCompleteStatus"></small></div></div><div id="todayInlineExerciseList" class="today-inline-exercise-list"></div>';
